...
`<leader>P` avoids LazyVim's common `<leader>p` yank-history mapping. If it conflicts with your own mappings, change it to any key you prefer, for example `<leader>sP`.
